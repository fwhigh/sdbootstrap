...
function innerbatchcmd () {
    sdbootstrap_ml_inner.py --test_file cadata_test --model LinearRegression --n_boot 100 ;
    #sdbootstrap_ml_inner.py --test_file cadata_test --model GradientBoostingRegressor --n_boot 100 ;
    # sdbootstrap_ml_inner.py --test_file cadata_test --model RandomForestRegressor --n_boot 100 ;
    #sdbootstrap_ml_inner.py --model DummyRegressor ;
}
